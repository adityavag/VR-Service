...
const VendorUpdate = () => {
    ...
    useEffect(() => {
        axios.get(`http://localhost:8080/api/vendors/${vendorKey}`)
        .then((res) => {
        ...
        <div>
            ...
            <div className="min-h-screen bg-gray-100 mx-auto p-6 md:p-10">
                <div className="bg-white rounded-md shadow-md p-8 md:w-3/4 mx-auto">
                    ...
                    <div className="text-2xl font-semibold text-center mt-4">Update Vendor</div>
                    <form onSubmit={handleSubmit}>
                        <div className="grid w-full items-center gap-4">
                            ...
                            <div className="flex justify-center mt-4">
                                <button
                                    type="submit"
                                    className="text-white bg-black p-2 text-center rounded-md w-3/4">Update Vendor</button>
                            </div>
                        </div>
                    </form>
                </div>
